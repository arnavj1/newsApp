function doXMLHttpRequest(){
    ...
    //api url
    var url = 'https://newsapi.org/v2/top-headlines?sources=espn&apiKey=601bad2189254152a32bab894de96b64'
    ...
    function processResponse(responseJSON) {
        ...
        console.log(article);
            ...
            document.getElementById("responseArea4").innerHTML = '<img class="photo" src="' + urlToImage + '"alt="background.jpg">';
            ...
            document.getElementById("responseArea8").innerHTML = '<img class="photo" src="' + urlToImage1 + '"alt="background.jpg">';
            ...
            document.getElementById("responseArea12").innerHTML = '<img class="photo" src="' + urlToImage2 + '"alt="background.jpg">';
            ...
            document.getElementById("responseArea16").innerHTML = '<img class="photo" src="' + urlToImage3 + '"alt="background.jpg">';
            ...
            document.getElementById("responseArea20").innerHTML = '<img class="photo" src="' + urlToImage4 + '"alt="background.jpg">';
